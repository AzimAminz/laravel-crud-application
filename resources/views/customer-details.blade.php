                    ...
                    <div class="px-4 pt-0 pb-4 cover">
                        <div class="media align-items-end profile-head d-flex">
                            <div class="profile mr-3">
                                <img src="{{ $customer->image == '/default-images/avatar.png' ? asset('default-images/avatar.png') : asset('uploads/' . $customer->image) ;}}" alt="{{ $customer->first_name }} image" width="100" class="rounded mb-2 img-thumbnail">
